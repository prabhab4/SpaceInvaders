...
public class Player extends Entity{
	...
	public void update() {
		...
		//if (Gdx.input.isKeyPressed(Keys.SPACE)) {
			if (System.currentTimeMillis() - lastFire >= 350) {//gap of 250milsec, 1/4 of sec
				entityManager.addEntity(new Missile(pos.cpy().add(13, TextureManager.PLAYER.getHeight())));
